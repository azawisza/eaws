...
package cmd
{
	 ...
	 * */
	public class cmd_RetriveXMLDataAmazon implements Command
	{
	
		private var xmlUrl:String= "";
		private var logger:ILogger = Log.getLogger("cmd.cmd_RetriveXMLDataAmazon");
		public function cmd_RetriveXMLDataAmazon(xmlUrl:String)
		{
			this.xmlUrl=xmlUrl;
		}
		...
		public function execute():void
		{
			...
			var result:WebServiceResultReceiver = WSResultParserAmazon.getInstance();
			service.url=xmlUrl;
